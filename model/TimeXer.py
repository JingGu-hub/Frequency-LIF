...
class Encoder(nn.Module):
    ...
    def forward(self, x, cross, x_mask=None, cross_mask=None, tau=None, delta=None, t=0):
        for layer in self.layers:
            x = layer(x, cross, x_mask=x_mask, cross_mask=cross_mask, tau=tau, delta=delta, t=t)
...
class EncoderLayer(nn.Module):
    def __init__(self, self_attention, cross_attention, d_model, d_ff=None,
                 dropout=0.1, activation="relu", configs=None):
    ...
    def forward(self, x, cross, x_mask=None, cross_mask=None, tau=None, delta=None, t=0):
        ...
        conv_out = self.conv1(y.transpose(-1, 1))
...
class Model(nn.Module):
    ...
    def forecast_multi(self, x_enc, x_mark_enc, x_dec, x_mark_dec, t=0):
        if self.use_norm:
        ...
        enc_out = self.encoder(en_embed, ex_embed, t=t)
    ...
    def forward(self, multi_batch_x, multi_batch_x_mark, x_dec, x_mark_dec, mask=None):
        ...
        for t in range(self.T):
            ...
            dec_out = self.forecast_multi(x_enc, x_mark_enc, x_dec, x_mark_dec, t=t)
