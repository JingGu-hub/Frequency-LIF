...
class Encoder(nn.Module):
    ...
    def forward(self, x, num_patches_list, n_vars, x_mask=None, tau=None, delta=None, t=0):
        for layer in self.layers:
            x, num_tokens_list = layer(x, num_patches_list, n_vars, x_mask=x_mask, tau=tau, delta=delta, t=t)
...
class EncoderLayer(nn.Module):
    def __init__(self, self_attention,
                 ...
                 n_vars=7, num_global_tokens=1, n_heads=8, batch_size=16, configs=None):
    ...
    def forward(self, x, num_patches_list, n_vars, x_mask=None, tau=None, delta=None, t=0):
        ...
        conv_out = self.conv1(x.transpose(-1, 1))
...
class Model(nn.Module):
    ...
    def __init__(self, configs):
        ...
        self.patch_lens = [16 for _ in range(configs.enc_in)]

        self.n_vars = 1 if configs.features == 'MS' else configs.enc_in
        self.num_global_tokens = configs.num_global_tokens
        self.sampling_periods = [1 for _ in range(configs.enc_in)]
        ...
        self.head = PerPeriodProjectionHead(
            ...
            sampling_periods=self.sampling_periods,
    ...
    def forecast_multi(self, x_enc, x_mark_enc, x_dec, x_mark_dec):
        ...
        channel_wise_patch_embed, num_patches_list, n_vars = self.channel_wise_patch_embedding(x_enc.permute(0, 2, 1), self.keep_prob)
