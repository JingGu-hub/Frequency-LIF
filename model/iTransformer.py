...
class Model(nn.Module):
    ...
    def forecast(self, multi_batch_x, multi_batch_x_mark, x_dec, x_mark_dec):
        dec_out_list = []
        ...
        for t in range(self.T):
            ...
            enc_out, attns = self.encoder(enc_out, attn_mask=None, t=t)
    ...
    def forward(self, multi_batch_x, multi_batch_x_mark, x_dec, x_mark_dec, mask=None):
        dec_out, attns = self.forecast(multi_batch_x, multi_batch_x_mark, x_dec, x_mark_dec)
